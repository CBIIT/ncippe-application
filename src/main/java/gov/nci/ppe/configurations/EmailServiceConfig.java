...
public class EmailServiceConfig {
	...
	/* The below properties are related to the action - upload test report for participant */
	...
	/* The above properties are related to the action - upload test report for participant */
	...
	/* The above properties are related to the action - upload eConsent Form for participant */	
	
	/* The below properties are related to the action - Email confirmation to Admin who uploads biomarker report */
	...
	/* The above properties are related to the action - Email confirmation to Admin who uploads biomarker report */
	
	/* The below properties are related to the action - Email confirmation to CRC when patient withdraws participation */
	...
	/* The above properties are related to the action - Email confirmation to CRC when patient withdraws participation */
	...
	/* The above properties are related to the action - Email confirmation to Patient when CRC withdraws a particular patient's participation */
